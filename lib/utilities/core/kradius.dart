...
const kBorderBGrey2 = Border(
  bottom: BorderSide(color: CustomColors.grey, width: 2),
);
const kBorderB = Border(
  bottom: BorderSide(color: CustomColors.grey, width: 1),
);
const kBorderB2 = Border(
  bottom: BorderSide(color: CustomColors.black, width: 2),
);
const kBorderBW3 = Border(
  bottom: BorderSide(
...
const kBorderBW3Transparent = Border(
  bottom: BorderSide(
...
final kBorderAll5Blue = Border.all(color: CustomColors.blue, width: 5);
...
final kBorderAllGrey2 = Border.all(color: CustomColors.mobileNoGrey, width: 1);
final kBorderAllGrey05 = Border.all(color: CustomColors.grey, width: 0.5);
final kBorderAllGrey05_2 =
    Border.all(color: CustomColors.mobileNoGrey, width: 0.5);
final kBorderAllBlack05 = Border.all(color: CustomColors.black, width: 0.5);
final kBorderAllGreyW5 =
    Border.all(color: CustomColors.grey2.withOpacity(0.5), width: 5);

final kBorderAllFaintGrey = Border.all(color: CustomColors.faintGrey, width: 1);
...
const kBorderT = Border(
  top: BorderSide(color: CustomColors.floatGrey, width: 1),
);
const kBorderRight =
    Border(right: BorderSide(color: CustomColors.black, width: 1));
final kBorderFaintGrey = Border(
    bottom: BorderSide(color: CustomColors.grey.withOpacity(0.3), width: 1));
...
final kBorderRadiusTR10 = BorderRadius.only(topRight: Radius.circular(10.r));
final kBorderRadiusLR10 = BorderRadius.only(topLeft: Radius.circular(10.r));
...
final kBorderRadiusTopRBottomR200 = BorderRadius.only(
    topRight: Radius.circular(200.r), bottomRight: Radius.circular(200.r));

final kBorderRadiusBottomRight8 =
    BorderRadius.only(bottomRight: Radius.circular(8.r));

final kBorderRadiusTopLR8 = BorderRadius.only(
...
final kBorderRadiusTRBR5 = BorderRadius.only(
